...
- **沉浸首页**：React Bits 台词与角色列表动效；点击火花空闲零 RAF；支持减少动态效果、键盘推进和防菜单点击穿透。
- **高效探索页**：路由拆包、延迟搜索、响应式卡片货架和封面懒加载；卡片翻面与详情弹窗支持完整键盘操作。
...
完整 API 参考(给 AI / 调用方)见 `docs/AI-API.md`；Codex 本机反代配置见 `docs/LOCAL-CODEX-PROXY.md`；前端优化记录见 `docs/2026-07-10-home-ui-performance-pass-1.md` 和 `docs/2026-07-10-explore-ui-performance-pass.md`。
