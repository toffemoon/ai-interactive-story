...
export const BEATS = [
  ...
  {
    // 纯台词拍,不做演示:创作功能太大,onboarding 里不展开(投射画板已删),具体上手引到「创作」页(执笔人详细带)。
    id: "tryCreate",
    emo: "proud",
    tour: "create",
    line: () =>
      "至于怎么把它们搭起来——三言两语说不完。真想动手,去「创作」那儿,执笔人会陪你用聊天的方式,把你的想法落地。", // 2026-07-17 雨钦口授改稿
    backLine: () => "创作那儿,执笔人会陪你用聊天的方式,把想法落地。",
    backEmo: "proud",
  ...
  },
  {
    id: "createRealize",
    emo: "spark",
    line: () => "你的想法,不用只锁在脑子里。在这儿,它能变成可以对话的故事和人——被人看见,被人欣赏。", // 2026-07-17 雨钦口授改稿(弃「长出来」)
    backLine: () => "想法不用只留在脑子里,在这儿能变成可以对话的故事。",
    backEmo: "smile",
