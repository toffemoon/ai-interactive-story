...
- 本 repo 的**任务 / bug / UI 问题（截图）/ 客户需求** → 走团队 **Linear**（2026-06-15 起,见父 repo `decisions/2026-06-15-tooling-linear.md`）;PR 用 `Fixes ENG-NN` 自动联动关 issue。(团队 2026-06-15 舍弃 Excalidraw、暂缓 LibTV。)
